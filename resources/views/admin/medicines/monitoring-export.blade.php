...
<head>
    ...
    <title>Laporan Monitoring Stok Apotek Pakis Medika Utama</title>
    <style>
        @page {
            size: A4;
...
<body>
    ...
    <div class="doc-header">
        ...
        <div class="header-right">
            <span class="doc-title">LAPORAN MONITORING STOK</span>
    ...
    <div class="summary-banner">
        ...
        <div class="sum-box">
            <div class="s-lbl">Stok Kritis (Database)</div>
            <div class="s-val s-val-red">{{ $metrics['stok_kritis'] }} Item</div>
        </div>
        <div class="sum-box">
            <div class="s-lbl">Hampir Kadaluwarsa</div>
            <div class="s-val s-val-blue">{{ $metrics['hampir_expired'] }} Item</div>
        </div>
        <div class="sum-box">
            <div class="s-lbl">Total Item Aktif</div>
            <div class="s-val">{{ number_format($metrics['total_aktif'], 0, ',', '.') }} SKU</div>
        </div>
    </div>
