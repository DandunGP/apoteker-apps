...
<div>
    ...
    <div class="service-form-card">
        <div class="form-title">Tambah Layanan Baru</div>
        ...
        <form action="{{ route('services.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama" id="nama" class="form-input" placeholder="Contoh: Cek Gula Darah" value="{{ old('nama') }}" required>
            ...
            <div class="form-group">
                ...
                <input type="number" name="harga" id="harga" class="form-input" placeholder="Contoh: 15000" value="{{ old('harga') }}" required>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn-submit">Simpan Layanan Baru</button>
            </div>
        </form>
    </div>
</div>
