...
<div class="breadcrumb">
    ...
    <span>&gt;</span>
    <span class="active">Tambah Layanan</span>
</div>
...
<div style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 80vh; padding: 2rem 0;">
    ...
    <div style="width: 100%; max-width: 550px; margin-bottom: 2rem;">
        ...
        <h1 style="font-size: 28px; font-weight: 800; margin-top: 1rem; color: var(--text-dark);">Tambah Layanan Baru</h1>
        <p style="color: var(--text-muted); font-size: 14px; margin-top: 0.5rem;">Masukkan detail layanan jasa atau pemeriksaan kesehatan baru.</p>
    </div>
        ...
        <form action="{{ route('services.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <div style="position: relative;">
                    ...
                    <input type="text" name="nama" class="form-input" style="padding-left: 3rem;" placeholder="Contoh: Cek Gula Darah" value="{{ old('nama') }}" required>
                </div>
            ...
            <div class="form-group">
                ...
                <div style="position: relative;">
                    ...
                    <input type="number" name="harga" class="form-input" style="padding-left: 3rem;" placeholder="15000" value="{{ old('harga') }}" required>
                </div>
