...
<div>
    ...
    <div class="breadcrumb">
        ...
        <span>&gt;</span>
        <span class="active">Tambah Obat</span>
    </div>

    <!-- Medicine Form Card -->
    <div class="medicine-form-card">
        <div class="form-title">Tambah Obat Baru</div>
        ...
        <form action="{{ route('medicines.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="kode" id="kode" class="form-input" placeholder="Contoh: PCT001" required value="{{ old('kode') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama" id="nama" class="form-input" placeholder="Masukkan nama lengkap obat" required value="{{ old('nama') }}">
            ...
            <div class="form-group">
                ...
                <select name="kategori" id="kategori" class="form-select" required>
                    ...
                    <option value="Obat Terbatas" {{ old('kategori') == 'Obat Terbatas' ? 'selected' : '' }}>Obat Terbatas</option>
                    ...
                    <option value="Alat Kesehatan" {{ old('kategori') == 'Alat Kesehatan' ? 'selected' : '' }}>Alat Kesehatan</option>
                </select>
            </div>
            ...
            <div class="form-row-grid">
                <div class="form-group">
                    ...
                    <input type="number" name="harga" id="harga" class="form-input" placeholder="0" required value="{{ old('harga') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="min_stok" id="min_stok" class="form-input" placeholder="10" required value="{{ old('min_stok', 10) }}">
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn-submit">Simpan Data Obat</button>
            </div>
        </form>
    </div>
</div>
